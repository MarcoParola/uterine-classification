...
class UterineSegmentationDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_path = os.path.join(os.path.dirname(self.annonations), "gyn1", self.dataset["images"][idx]["file_name"])
...
def main(cfg):
    ...
    train_dataset = UterineSegmentationDataset(cfg.dataset.train, transform=train_img_tranform)
    for i in range(2):
