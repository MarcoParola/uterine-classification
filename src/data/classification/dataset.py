...
class UterineClassificationDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_path = os.path.join(os.path.dirname(self.annonations), "gyn1", image["file_name"])
...
if __name__ == "__main__":
    ...
    '''
    dataset_cropped = UterineClassificationDataset(
    ...
    dataset_not_cropped = UterineClassificationDataset(
    ...
    '''
    dataset = UterineClassificationSaliencyDataset(
        "data/train.json", False,
        transform=transforms.Compose([
            transforms.Resize((512, 512), antialias=True),
            transforms.ToTensor()
